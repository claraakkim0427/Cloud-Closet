...
public class EditChooseShoesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userId != null) {
            ...
            Log.e("EditChooseShoesActivity", "No user ID found in SharedPreferences.");
        }
    }
    private void loadFirebaseData(String userId) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("EditChooseShoesActivity", "Error loading closet data: " + databaseError.getMessage());
            }
        });
    }
}