...
public class EditChooseBottomsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userId != null) {
            ...
            Log.e("EditChooseBottomsActivity", "No user ID found in SharedPreferences.");
        }
    }
    private void loadFirebaseData(String userId) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("EditChooseBottomsActivity", "Error loading closet data: " + databaseError.getMessage());
            }
        });
    }
}
