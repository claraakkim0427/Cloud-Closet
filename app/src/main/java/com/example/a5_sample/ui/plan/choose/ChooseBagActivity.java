...
public class ChooseBagActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (userId != null) {
            ...
            Log.e("ChooseBagActivity", "No user ID found in SharedPreferences.");
        }
    }
    private void loadFirebaseData(String userId, String id) {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Log.e("ChooseBagActivity", "Error loading closet data: " + databaseError.getMessage());
            }
        });
    }
}
